            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col bg-dark text-white">
                  <a href="nosproduits.php"><a href="nosproduits.php"><img class="img-fluid" src="img/loupe2.png" alt="vue">&nbsp;&nbsp;Aller sur la page</a></a>
                </div>
              </div>
        ...
        <div class="col ml-6">
          ...
          <div class="ajuster text-center">
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col bg-dark text-white">
                  <a href="nosproduits.php"><img class="img-fluid" src="img/loupe2.png" alt="vue">&nbsp;&nbsp;Aller sur la page</a>
                </div>
              </div>
            </div>
          </div>
